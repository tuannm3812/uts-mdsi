...
- [project-15/agent-collaboration-log.md](project-15/agent-collaboration-log.md) — running open discussion between Tuan, Claude, and Codex. Read the latest entries before starting work here, and append a new entry (don't edit past ones) when you make a notable decision, finding, or handoff.
