...
# 36121 AT3 - Assessment Draft

## Official Task Evidence

Mapped source files copied into `assignments/raw/assignments/AI_at3/`.

## Raw Source Files

- `assignments/raw/assignments/AI_at3/README.md` (md)
- `assignments/raw/assignments/AI_at3/Untitled0.ipynb` (notebook)
- `assignments/raw/assignments/AI_at3/accessgen-ai-powered-meal-planning.ipynb` (notebook)
