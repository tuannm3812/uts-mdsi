...
Mapped source files copied into `assignments/raw/assignments/AI_at1/`.

## Raw Source Files

- `assignments/raw/assignments/AI_at1/36121-Assignment 1-Manh Tuan Nguyen-25739083.pdf` (pdf)
- `assignments/raw/assignments/AI_at1/AIPA-Assignment 1-25739083.ipynb` (notebook)
- `assignments/raw/assignments/AI_at1/AIPA-Assignment 1-25739083_v0.ipynb` (notebook)
- `assignments/raw/assignments/AI_at1/Sample Datasets-2 data job posts.csv` (csv)
