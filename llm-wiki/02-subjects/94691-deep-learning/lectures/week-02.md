...
# Week 02 - Image Processing, Edge Detection, and Machine Learning Review

## Source Files

- `lectures/raw/deep_learning_slide/Deep Learning - Lecture 2 (assignment brief).pdf` (lecture)
- `lectures/raw/deep_learning_slide/Note/94691 DL - Module 2 - Note.pdf` (lecture)
- `lectures/raw/deep_learning_slide/Note/Deep Learning - Lecture 2 - Note.pdf` (lecture)
- `lectures/raw/deep_learning_slide/dl_slide_2025/Deep Learning - Lecture 2.pptx.pdf` (lecture)
- `notebooks/raw/dl_notebooks/Deep Learning_Lab2_Exercise1_Solution.ipynb` (notebook)
- `notebooks/raw/dl_notebooks/Deep Learning_Lab2_Exercise2_Solution.ipynb` (notebook)
- `notebooks/raw/dl_notebooks/Deep Learning_Lab2_Exercise3_Solution.ipynb` (notebook)
- `notebooks/raw/dl_notebooks/dl_notebooks_2025/week_2/Week2-Lab2-EdgeDetection.ipynb` (notebook)
- `notebooks/raw/dl_notebooks/dl_notebooks_2025/week_2/Week2-Lab2-MachineLearning.ipynb` (notebook)
...
- Supports Assignment 1 foundations where image representations and classical feature processing matter.
