...
|---|---|---:|---|
| Session 01 | NLP Foundations, Text Preprocessing, and Corpora | 5 | [note](../lectures/session-01.md) |
| Session 02 | Text Analysis, Topic Modelling, and Clustering | 4 | [note](../lectures/session-02.md) |
| Session 03 | Summarisation, Text Classification, and Sentiment Analysis | 5 | [note](../lectures/session-03.md) |
| Session 04 | Word Embeddings and Deep Learning Models | 5 | [note](../lectures/session-04.md) |
| Session 05 | BERT, Hugging Face Models, and Applied Interfaces | 4 | [note](../lectures/session-05.md) |
| Session 06 | LLM Prompting and Generative NLP Workflows | 4 | [note](../lectures/session-06.md) |
| Session 08 | Evaluation, Responsible NLP, and Project Communication | 2 | [note](../lectures/session-08.md) |
