...
| T-039 | Send Tuan a Teams invite for Friday 7 August, 12pm, per Arnick's direct request | **Not started — needs Tuan.** Not automatable from here (no Teams/Outlook access this session). Arnick's message recorded verbatim | `communications/arnick-message-2026-08-05-direction-correction.md` |
