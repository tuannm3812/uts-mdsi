...
| T-038 | Full-text verification of the 11-paper forecasting literature scan (T-031) against Crossref/publisher/institutional access, plus a proper Scopus/Web of Science search pass — this round was web-search-abstract-level only, and two sources (ScienceDirect, IEEE Xplore) were paywall-blocked entirely | **Not started** | `research/week-02-forecasting-literature-scan-2026-08-06.md` |
