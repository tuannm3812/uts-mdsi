...
| T-039 | Send Tuan a Teams invite for Friday 7 August, 12pm, per Arnick's direct request | **Not started — needs Tuan.** Not automatable from here (no Teams/Outlook access this session). Arnick's message recorded verbatim. Recommend including the public Kaggle notebook links in the invite description (draft below) — per the execution plan's own "send artefacts before meetings" guidance, and Arnick has never actually been sent the link (the 3 Aug brief predates it going public) | `communications/from-arnick-2026-08-05-direction-correction.md` |
